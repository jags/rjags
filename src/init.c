...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"clear_monitor",             (DL_FUNC) &clear_monitor,             6},
    ...
    {"get_monitored_values",      (DL_FUNC) &get_monitored_values,      3},
    {"get_monitored_values_flat", (DL_FUNC) &get_monitored_values_flat, 3},
    {"get_nchain",                (DL_FUNC) &get_nchain,                1},
    {"get_nthread",               (DL_FUNC) &get_nthread,               1},
    ...
    {"initialize3",               (DL_FUNC) &initialize3,               3},
    ...
    {"set_monitors",              (DL_FUNC) &set_monitors,              7},
    {"set_nthread",               (DL_FUNC) &set_nthread,               2},
